...
const TimeStamp: React.FC<YoutubeLinkTimestampProps> = ({ values, setFieldValue }) => {
  return (
    <div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    ...
                    <Field
                      ...
                      className="input-box"
                    />
                    <ErrorMessage name={`matchVideoLinks[${index}]`} component="div" className="error" />
                  </div>
                </div>
                ...
                <FieldArray name={`timestamps[${index}]`}>
                  {({ push: pushTimestamp, remove: removeTimestamp }) => (
                    <div className="timestamp-container">
                      {values.timestamps[index]?.map((timestamp: Timestamp, tsIndex: number) => (
                        <div className="row" key={tsIndex}>
                          ...
                          <div className="col-md-12 text-end">
                            {values.timestamps[index].length > 1 && tsIndex > 0 && (
                              <a
                                href="#"
                                onClick={(e) => {
                                  e.preventDefault();
                            ...
                            {tsIndex === values.timestamps[index].length - 1 && (
                              <a
                                href="#"
                                onClick={(e) => {
                                  e.preventDefault();
