      ...
      <nav className="navbar navbar-expand-lg navbar-light">
        <div className="container">
          <a className="navbar-brand" href="#">
            <img src="images\tennis-cricket-logo.png" alt="tennisCricket" />
          </a>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div className="navLeft">
              ...
              {/* <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="search-icon">
                <path d="M505 442.7L405.3 343c28.4-34.6 45.7-78.4 45.7-126C451 97.2 353.8 0 226 0S1 97.2 1 217s97.2 217 217 217c47.6 0 91.4-17.3 126-45.7L442.7 505c12.5 12.5 32.8 12.5 45.3 0l17-17c12.5-12.5 12.5-32.8 0-45.3zM226 362c-80.8 0-146-65.2-146-146S145.2 70 226 70s146 65.2 146 146-65.2 146-146 146z"/>
              </svg> */}

              <img className="play-store" src="images\playstoreLogo.png" alt="playstore" />

              <img className="image" src="images\img.png " alt="image" />
