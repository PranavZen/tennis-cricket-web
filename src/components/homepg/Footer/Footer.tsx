...
<div className="mentioned-section">
    ...
    <div className="mentioned-logos">
            <img className="clientImg1" src="images\clientImg1.png" alt="Company 1"/>       
            <img className="clientImg2" src="images\clientImg2.png" alt="Company 2"/>       
            <img className="clientImg3" src="images\clientImg3.png" alt="Company 3"/>       
            <img className="clientImg4" src="images\clientImg4.png" alt="Company 4"/>     
            <img className="clientImg5" src="images\clientImg5.png" alt="Company 5"/>     
            <img className="clientImg6" src="images\clientIng6.png" alt="Company 6"/>
            <img className="clientImg7" src="images\clientImg7.png" alt="Company 7"/>
    </div>
</div>
